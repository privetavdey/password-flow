    ...
    >
      ...
      >
        ...
        >
          <div className="content-stretch flex items-center justify-between relative shrink-0 w-[353px]" data-node-id="5567:32642">
            <div 
              ...
              style={{ borderColor: COLORS.BORDER, borderRadius: BORDER_RADIUS.full }}
              data-name="image" 
            ...
            >
              <div 
                ...
                style={{ backgroundColor: COLORS.BG_SUBTLE, padding: SPACING.sm, borderRadius: BORDER_RADIUS.md }}
                data-name="Frame" 
          ...
          <div 
            ...
            style={{ 
              backgroundImage: `linear-gradient(to bottom, rgba(255,255,255,0), ${COLORS.BG_SUBTLE})`,
              paddingLeft: SPACING.md,
              paddingRight: SPACING.md,
              paddingBottom: '19px', // Custom spacing
          ...
          >
            ...
            >
              <p 
                ...
                style={{ color: COLORS.TEXT_PRIMARY, opacity: 0.48, fontWeight: 600 }}
              ...
              >
                ...
                >
                  ...
                  <span className="leading-none" style={{ color: COLORS.TEXT_TERTIARY }}>.89</span>
                </p>
                        ...
                        <div className="flex-none rotate-[180deg]">
                          <div className="opacity-48 overflow-clip relative size-[20px]" data-name="arrow-down" data-node-id="5567:32557">
                            <div className="absolute h-[7px] left-1/2 top-1/2 translate-x-[-50%] translate-y-[-50%] w-[11px]" data-name="Vector" data-node-id="I5567:32557;3706:25714">
                              <div className="absolute inset-0" style={{ "--fill-0": COLORS.TEXT_PRIMARY } as React.CSSProperties}>
        ...
        <div className="content-stretch flex gap-[27px] items-center relative shrink-0" data-node-id="5567:32569">
          {[
            { img: imgClock, label: 'Send' },
            { img: imgClock1, label: 'Receive' },
            { img: imgClock2, label: 'Shield' },
            { img: imgFrame2147225787, label: 'Swap' },
            { img: imgFrame626766, label: 'Records' },
          ].map((item, index) => (
            <div key={index} className="content-stretch flex flex-col gap-[12px] items-center relative shrink-0" style={{ width: index === 1 || index === 4 ? '51px' : index === 2 ? '43px' : '40px' }}>
              <div 
                className="content-stretch flex items-center justify-center relative shrink-0 size-[48px]"
                style={{ backgroundColor: COLORS.BG_SUBTLE, padding: SPACING.sm, borderRadius: BORDER_RADIUS.sm }}
              >
        ...
        <div 
          ...
          style={{ 
            backgroundImage: `linear-gradient(to bottom, ${COLORS.BG_SUBTLE}, rgba(255,255,255,0))`,
            paddingLeft: SPACING.md,
            paddingRight: SPACING.md,
            paddingTop: '20px',
            borderRadius: BORDER_RADIUS.md
          ...
          <div className="content-stretch flex flex-col gap-[48px] items-center relative shrink-0 w-[353px]" data-node-id="5567:32493">
            <div className="content-stretch flex flex-col gap-[24px] items-start relative shrink-0 w-full" data-name="Frame" data-node-id="5567:32494">
              ...
              <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
                <div className="content-stretch flex items-center relative shrink-0">
                  <div 
                    ...
                    style={{ backgroundColor: COLORS.BACKGROUND, borderColor: COLORS.BORDER, borderRadius: BORDER_RADIUS.full }}
                  >
                ...
                <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-h-px min-w-px relative">
                  <div className="content-stretch flex flex-col font-innovator items-start justify-center not-italic relative shrink-0 uppercase">
                    <p className="leading-[1.35] relative shrink-0 text-[15px] tracking-[0.15px]" style={{ color: COLORS.TEXT_PRIMARY, fontWeight: 600 }}>aleo</p>
                    <p className="leading-[1.4] relative shrink-0 text-[13px] tracking-[0.13px]" style={{ color: COLORS.TEXT_SECONDARY }}>125,077 aleo</p>
                  </div>
                  <div className="content-stretch flex flex-col items-end justify-center relative shrink-0">
                    <p className="font-innovator leading-[1.35] not-italic relative shrink-0 text-[15px] text-right tracking-[0.15px] uppercase" style={{ color: COLORS.TEXT_PRIMARY, fontWeight: 600 }}>$15,009</p>
                  </div>
                </div>
              </div>
              ...
              <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
                ...
                <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-h-px min-w-px relative">
                  <div className="content-stretch flex flex-col font-innovator items-start justify-center not-italic relative shrink-0">
                    <p className="leading-[1.35] relative shrink-0 text-[15px]" style={{ color: COLORS.TEXT_PRIMARY, fontWeight: 600 }}>Pondo</p>
                    <p className="leading-[1.4] relative shrink-0 text-[13px] tracking-[0.13px] uppercase" style={{ color: COLORS.TEXT_SECONDARY }}>3,171,936 pndo</p>
                  </div>
                  <div className="content-stretch flex flex-col items-end justify-center relative shrink-0">
                    <p className="font-innovator leading-[1.35] not-italic relative shrink-0 text-[15px] text-right tracking-[0.15px] uppercase" style={{ color: COLORS.TEXT_PRIMARY, fontWeight: 600 }}>$2,648</p>
                  </div>
                </div>
              </div>
              ...
              <div className="content-stretch flex gap-[16px] items-center relative shrink-0 w-full">
                ...
                <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-h-px min-w-px relative">
                  <div className="content-stretch flex flex-col font-innovator items-start justify-center not-italic relative shrink-0">
                    <p className="leading-[1.35] relative shrink-0 text-[15px]" style={{ color: COLORS.TEXT_PRIMARY, fontWeight: 600 }}>vUSDC</p>
                    <p className="leading-[1.4] relative shrink-0 text-[13px] tracking-[0.13px] uppercase" style={{ color: COLORS.TEXT_SECONDARY }}>0 VUSDC</p>
                  </div>
                  <div className="content-stretch flex flex-col items-end justify-center relative shrink-0">
                    <p className="font-innovator leading-[1.35] not-italic relative shrink-0 text-[15px] text-right tracking-[0.15px] uppercase" style={{ color: COLORS.TEXT_PRIMARY, fontWeight: 600 }}>$0.00</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="content-stretch flex flex-col gap-[15px] items-center opacity-50 relative shrink-0 w-[154px]">
              <p className="font-innovator leading-none min-w-full not-italic relative shrink-0 text-[15px] w-[min-content]" style={{ color: COLORS.TEXT_PRIMARY, fontWeight: 500 }}>
                Don’t see your token?
              </p>
              <div 
                className="backdrop-blur-[24px] border border-solid content-stretch flex h-[40px] items-center relative shrink-0"
                style={{ backgroundColor: COLORS.BG_SUBTLE, borderColor: COLORS.BORDER_SUBTLE, paddingLeft: SPACING.md, paddingRight: SPACING.md, paddingBottom: SPACING.sm, paddingTop: SPACING.sm, borderRadius: BORDER_RADIUS.full }}
              >
                <p className="font-innovator leading-none not-italic relative shrink-0 text-[15px]" style={{ color: COLORS.TEXT_QUINARY, fontWeight: 600 }}>
                  Manage tokens
                </p>
              </div>
            </div>
      ...
      <div className="absolute bottom-0 h-[34px] left-1/2 translate-x-[-50%] w-[393px]">
        <div className="absolute bottom-[8px] flex h-[5px] items-center justify-center left-1/2 translate-x-[-50%] w-[139px]">
          <div className="flex-none rotate-[180deg] scale-y-[-100%]">
            <div className="h-[5px] rounded-[100px] w-[139px]" style={{ backgroundColor: COLORS.TEXT_PRIMARY }} />
          </div>
        </div>
      </div>
      ...
      <div className="absolute h-[54px] left-1/2 top-0 translate-x-[-50%] w-[393px]">
        <div className="absolute h-[54px] left-0 right-[64.25%] top-1/2 translate-y-[-50%]">
          <p className="absolute font-sf inset-[33.96%_36.71%_25.3%_36.96%] leading-[22px] text-[17px] text-center" style={{ color: COLORS.TEXT_PRIMARY, fontWeight: 600 }}>
            1:43
          </p>
        </div>
        <div className="absolute h-[54px] left-[64.25%] right-0 top-1/2 translate-y-[-50%]">
           {/* Battery, Wifi, Cellular - simplified for brevity but matching structure */}
           <div className="absolute bottom-[33.33%] contents left-[calc(50%+32.41px)] top-[42.59%] translate-x-[-50%]">
            <div className="absolute border border-solid bottom-[33.33%] left-[calc(50%+31.25px)] opacity-35 rounded-[4.3px] top-[42.59%] translate-x-[-50%] w-[25px]" style={{ borderColor: COLORS.TEXT_PRIMARY }} />
            ...
            <div className="absolute bottom-[37.04%] left-[calc(50%+31.25px)] rounded-[2.5px] top-[46.3%] translate-x-[-50%] w-[21px]" style={{ backgroundColor: COLORS.TEXT_PRIMARY }} />
          </div>
      ...
      <div 
        ...
        style={{ backgroundColor: 'rgba(9,7,7,0.64)', borderColor: COLORS.BORDER_SUBTLE, padding: SPACING.sm, borderRadius: BORDER_RADIUS.lg }}
      >
        ...
        <div className="absolute inset-0 pointer-events-none rounded-[inherit] shadow-[inset_0px_0px_20px_0px_rgba(255,255,255,0.08)]" />
      </div>
    </div>
  );
}
